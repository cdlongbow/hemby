...
object SeekbarDefaults {
	...
	@Composable
	fun colors(
		backgroundColor: Color = EmbyTheme.colorScheme.rangeControlBackground,
		bufferColor: Color = EmbyTheme.colorScheme.seekbarBuffer,
		progressColor: Color = EmbyTheme.colorScheme.rangeControlFill,
		knobColor: Color = EmbyTheme.colorScheme.rangeControlKnob,
	) = SeekbarColors(
