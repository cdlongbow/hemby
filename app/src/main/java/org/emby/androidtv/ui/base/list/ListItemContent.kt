		...
		Row(
			...
			Column(
				...
				overlineContent?.let { content ->
					ProvideTextStyle(EmbyTheme.typography.listOverline.copy(color = EmbyTheme.colorScheme.listOverline)) {
						content()
					}
				...
				captionContent?.let { content ->
					...
					ProvideTextStyle(EmbyTheme.typography.listCaption.copy(color = EmbyTheme.colorScheme.listCaption)) {
						content()
					}
				}
			}
