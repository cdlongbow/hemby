...
object ListControlDefaults {
	...
	@Composable
	fun colors(
		containerColor: Color = EmbyTheme.colorScheme.listButton,
		focusedContainerColor: Color = EmbyTheme.colorScheme.listButtonFocused,
	) = ListControlColors(
...
fun ListControl(
	...
	Box(
		...
		ListItemContent(
			...
			headingStyle = EmbyTheme.typography.listHeadline
				.copy(color = EmbyTheme.colorScheme.listHeadline),
		)
	}
}
