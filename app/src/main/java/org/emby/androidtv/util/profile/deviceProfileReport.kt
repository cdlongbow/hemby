package org.emby.androidtv.util.profile
...
import org.emby.androidtv.constant.Codec
import org.emby.androidtv.preference.UserPreferences
import org.emby.androidtv.util.AndroidVersion
import org.emby.androidtv.util.appendCodeBlock
import org.emby.androidtv.util.appendDetails
import org.emby.androidtv.util.appendItem
import org.emby.androidtv.util.appendSection
import org.emby.androidtv.util.appendValue
import org.emby.androidtv.util.buildMarkdown
...
fun createDeviceProfileReport(
	...
	// Header
	appendLine("---")
	appendLine("client: Emby for Android TV")
	appendLine("client_version: ${BuildConfig.VERSION_NAME}")
	appendLine("client_repository: https://github.com/cdlongbow/hemby")
